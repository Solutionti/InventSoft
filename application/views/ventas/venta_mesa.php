          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    id="disabled-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#otros-tab-pane"
                    type="button"
                    role="tab"
                    aria-controls="otros-tab-pane"
                    aria-selected="false"
              ...
              <div class="tab-content" id="myTabContent">
                ...
                >
                  <div class="row">
                  <?php foreach($categoria1->result() as $canchas) { ?>
                        <div class="col-md-3 mb-2 mt-5">
                      <div class="card card-bordered shadow-none text-center h-100">
                        <div class="card-pinned">
                              <img
                                class="card-img-top img-fluid"
                                src="<?php echo base_url();?>public/productos/<?php echo $canchas->url_imagen; ?>"
                                alt="Image Description"
                              >
                                <div class="codigo_producto" hidden><?php echo $canchas->codigo; ?></div>
                            </div>
                            <div class="card-body">
                              <a class="text-body" href="#"><?php echo $canchas->nombre; ?></a>
                              <p class="card-text text-dark">$<?php echo $canchas->precio; ?></p>
                            </div>
                ...
                >
                  <div class="row">
                  <?php foreach($categoria2->result() as $bebidas) { ?>
                    <div class="col-md-3 mb-2 mt-5">
                      <div class="card card-bordered shadow-none text-center h-100">
                        <div class="card-pinned">
                              <img
                ...
                >
                  <div class="row">
                  <?php foreach($categoria3->result() as $snacks) { ?>
                    <div class="col-md-3 mb-2 mt-5">
                      <div class="card card-bordered shadow-none text-center h-100">
                        <div class="card-pinned">
                              <img
                                class="card-img-top img-fluid"
                                src="<?php echo base_url();?>public/productos/<?php echo $snacks->url_imagen; ?>"
                                alt="Image Description"
                              >
                                <div class="codigo_producto" hidden><?php echo $snacks->codigo; ?></div>
                            </div>
                            <div class="card-body">
                              <a class="text-body" href="#"><?php echo $snacks->nombre; ?></a>
                              <p class="card-text text-dark">$<?php echo $snacks->precio; ?></p>
                            </div>
                            <div class="card-footer pt-0">
                              <a
                                type="button"
                ...
                >
                  <div class="row">
                  <?php foreach($categoria4->result() as $dulceria) { ?>
                    <div class="col-md-3 mb-2 mt-5">
                      <div class="card card-bordered shadow-none text-center h-100">
                        <div class="card-pinned">
                              <img
                                class="card-img-top img-fluid"
                                src="<?php echo base_url();?>public/productos/<?php echo $dulceria->url_imagen; ?>"
                                alt="Image Description"
                              >
                                <div class="codigo_producto" hidden><?php echo $dulceria->codigo; ?></div>
                            </div>
                            <div class="card-body">
                              <a class="text-body" href="#"><?php echo $dulceria->nombre; ?></a>
                              <p class="card-text text-dark">$<?php echo $dulceria->precio; ?></p>
                            </div>
                            <div class="card-footer pt-0">
                              <a
                                type="button"
                ...
                >
                  <div class="row">
                  <?php foreach($categoria5->result() as $otros) { ?>
                    <div class="col-md-3 mb-2 mt-5">
                      <div class="card card-bordered shadow-none text-center h-100">
                        <div class="card-pinned">
                              <img
                                class="card-img-top img-fluid"
                                src="<?php echo base_url();?>public/productos/<?php echo $otros->url_imagen; ?>"
                                alt="Image Description"
                              >
                                <div class="codigo_producto" hidden><?php echo $otros->codigo; ?></div>
                            </div>
                            <div class="card-body">
                              <a class="text-body" href="#"><?php echo $otros->nombre; ?></a>
                              <p class="card-text text-dark">$<?php echo $otros->precio; ?></p>
                            </div>
                            <div class="card-footer pt-0">
                              <a
                                type="button"
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <option value="<?php echo $mesas->numero_mesa; ?>"><?php echo $mesas->numero_mesa.' '.$mesas->puestos.' ( '.$mesas->estado.' )'?></option>
                    <?php } ?>
                  </select>
                  </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script src="<?php echo base_url(); ?>public/js/scripts/venta_mesas.js?=1.0.0"></script>
</body>
</html>
