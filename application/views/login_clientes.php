            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-center">
                  <!-- <img src="<?php echo base_url(); ?>public/img/theme/logoventas.png" width="90px;" class="img-fluid mb-3"> -->
                  <h3> <span class="text-primary h5 font-weight-bold mb-0">Invent</span> <span class="text-default h3 font-weight-bold">Soft</span> </h3>
                  <div class="stats">
                    <small class="">Software de ventas y Inventarios</small>
                  </div>
                </div>
                <div class="card-body">
                  ...
                  <form role="form" method="post" validate id="FormLOG">
                    ...
                    <div class="text-center">
                      <button
                        type="submit"
                        id="login"
                        class="btn btn-lg btn-dark text-white btn-lg w-100 mt-4 mb-0"
                      >
                        Ingresar
                      </button>
                    </div>
